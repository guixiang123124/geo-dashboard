      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md border-b border-slate-200 z-50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm text-slate-600">
            ...
            <a href="#diagnosis" className="hover:text-violet-600 transition">Diagnosis</a>
            <a href="#compete" className="hover:text-violet-600 transition">Compete</a>
            <a href="#pricing" className="hover:text-violet-600 transition">Pricing</a>
            <Link href="/audit" className="hover:text-violet-600 transition font-medium text-violet-600">Free Audit</Link>
          </div>
          <div className="flex items-center gap-3">
            <Link href="/"><Button variant="outline" size="sm">Sign In</Button></Link>
            <Link href="/audit"><Button size="sm" className="bg-violet-600 hover:bg-violet-700">Get Started Free</Button></Link>
          </div>
        </div>
      </nav>
