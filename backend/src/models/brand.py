...
class Brand(Base):
    ...
    # Metadata (using extra_data to avoid conflict with SQLAlchemy's metadata)
    extra_data: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)  # Additional flexible data
