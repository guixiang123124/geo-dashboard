...
from ..services.ai_clients import OpenAIClientWithRetry, AIResponse
from ..schemas.models import GEOScore
...
class EvaluationService:
    ...
    async def _calculate_brand_score(self, run_id: str, brand_id: str):
        ...
        # Calculate GEO scores using scorer
        ...
        composite = self._scorer.calculate_composite_score(
            visibility_score, citation_score, representation_score, intent_score
        )
    ...
    async def _get_ai_client(self, model_name: str):
        ...
        # TODO: Add other models (Gemini, Claude, Perplexity)
        else:
